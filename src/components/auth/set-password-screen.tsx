...
import { AuthCard, Button, Checkbox, Field, FieldLabel } from '@/components/ui/controls';
import { ErrorBox, Kicker, ScreenTitle, SuccessMark } from '@/components/ui/feedback';
import { checkPasswordPolicy } from '@/lib/password-policy';
import { call } from '@/lib/client-api';
import type { ResetConfirmResponse } from '@/lib/api-contract';
