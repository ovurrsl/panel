...
import { AuthCard, Button, Field, FieldLabel, SegBar, SegButton } from '@/components/ui/controls';
import { ErrorBox, ScreenTitle, SuccessMark } from '@/components/ui/feedback';
import { call } from '@/lib/client-api';
import type { AccessRequestResponse } from '@/lib/api-contract';
